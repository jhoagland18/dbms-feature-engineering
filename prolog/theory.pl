...
relationship('Ratings','Company',['companyid'],['companyid'],to1).
relationship('Company','locations',['null'],['null'],to1).
relationship('Company','Ratings',['companyid'],['companyid'],toN).
